...
void makeImagesMM(void){
	...
	mipmapImage2[0][0][0] = 255;
	mipmapImage2[0][0][1] = 255;
	mipmapImage2[0][0][2] = 255;
	mipmapImage2[0][0][3] = 255;
}
...
void initMM(void){
	...
	glGenTextures(1, &texNameMM);
	glBindTexture(GL_TEXTURE_2D, texNameMM);
